...
ALTER TABLE "PurchaseOrderMonitoringItem" ADD CONSTRAINT "PurchaseOrderMonitoringItem_poNumber_fkey"
  FOREIGN KEY ("poNumber") REFERENCES "PurchaseOrder"("poNumber") ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE "PurchaseOrderMonitoringItem" ADD CONSTRAINT "PurchaseOrderMonitoringItem_poItemId_fkey"
  FOREIGN KEY ("poItemId") REFERENCES "PurchaseOrderItem"("id") ON DELETE CASCADE ON UPDATE CASCADE;
